...
class AppointmentController extends Controller
{
    ...
    public function actionDoctorConsult()
    {
        ...
        if(isset($_GET['visit_id']) && isset($_GET['patient_id']) && isset($_GET['doctor_id']))
        {
            ...
            $this->render('consultation_form',$data,false,false);
    ...
    public function actionAddPayment($visit_id)
    {
        if ( Yii::app()->request->isPostRequest && Yii::app()->request->isAjaxRequest )
        {
            ...
            if(isset($_POST['Appointment']['us_discount']))
            {
                ...
                Yii::app()->treatmentCart->setUSDiscount($model->us_discount);
                //$model->us_discount=Yii::app()->treatmentCart->getAllDiscount($data['amount']);
            }
