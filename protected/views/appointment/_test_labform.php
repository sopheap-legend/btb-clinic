                    ...
                    <?php foreach (TreatmentGroup::model()->findAll("id=$hemograme_val") as $k=>$tgroup_val){ ?>
                        ...
                        <?php foreach ($lab_selected as $lab_selected_val){ ?>
                            <?php if($lab_selected_val['t_group_id']==$hemograme_val){ ?>
                                <?php
                                    $treatment_item=$lab_selected_val['treatment_item'];
                                ...
                                <?php if($lab_selected_val['blood_id']==4){ ?>
                                    <div>
                                        ...
                                        <?php echo TbHtml::textField("itemtest[$treatment_item][$lab_item_id]", '', array('class'=>"form-control",)); ?>
                                        <?php echo TbHtml::label('Rh', 'text'); ?>
                                        <?php echo TbHtml::textField("itemtest[$treatment_item".' Rh'."][$lab_item_id]",'' , array('class'=>"form-control",)); ?>
                                    </div>
                                <?php }elseif($lab_selected_val['blood_id']==16 || $lab_selected_val['blood_id']==17){ ?>
                                    <div>
                                        <?php echo TbHtml::label($lab_selected_val['treatment_item'], 'text'); ?>:
                                        <div class="input-group">
                                            <?php echo TbHtml::textField("itemtest$treatment_item".' mm'."][$lab_item_id]", '', array('class'=>"form-control",)); ?>
                                        ...
                                        <br/>
                                        <div class="input-group">
                                            <?php echo TbHtml::textField("itemtest$treatment_item".' sec'."][$lab_item_id]", '', array('class'=>"form-control",)); ?>
                                            <span class="input-group-addon">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-11 col-sm-offset-1">
                                                ...
                                                <?php echo TbHtml::textField("itemtest[$treatment_item".' IgG'."][$lab_item_id]",'' , array('class'=>"form-control",)); ?>
                                            </div>
                                            <div class="col-sm-11 col-sm-offset-1">
                                                <?php echo TbHtml::label('IgM', 'text'); ?>:
                                                <?php echo TbHtml::textField("itemtest[$treatment_item".' IgM'."][$lab_item_id]",'' , array('class'=>"form-control",)); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-11 col-sm-offset-1">
                                                ...
                                                <?php echo TbHtml::textField("itemtest[$treatment_item".' To'."][$lab_item_id]",'' , array('class'=>"form-control",)); ?>
                                            </div>
                                            <div class="col-sm-11 col-sm-offset-1">
                                                <?php echo TbHtml::label('TH', 'text'); ?>:
                                                <?php echo TbHtml::textField("itemtest[$treatment_item".' TH'."][$lab_item_id]",'' , array('class'=>"form-control",)); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-11 col-sm-offset-1">
                                                ...
                                                <div class="input-group">
                                                    <?php echo TbHtml::textField("itemtest[$treatment_item".' SGOT(ASAT)'."][$lab_item_id]",'' , array('class'=>"form-control")); ?>
                                                    <span class="input-group-addon">
                                            ...
                                            <div class="col-sm-11 col-sm-offset-1">
                                                ...
                                                <div class="input-group">
                                                    <?php echo TbHtml::textField("itemtest[$treatment_item".' SGPT(ALAT)'."][$lab_item_id]",'' , array('class'=>"form-control",)); ?>
                                                    <span class="input-group-addon">
