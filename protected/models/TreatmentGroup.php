 ...
 * @property TreatmentItemDetail[] $treatmentItemDetails
 */
class TreatmentGroup extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, treatment_id, group_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'treatmentItemDetails' => array(self::HAS_MANY, 'TreatmentItemDetail', 't_group_id'),
		);
	}
